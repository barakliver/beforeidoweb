  ...
  faq: [
    {
      ...
      a: 'הפוך. עדיף להציף דברים עכשיו בסלון עם כוס יין ופתיחות של דייט, מאשר לגלות פערים בארוחת שישי אצל ההורים שלה או שבוע אחרי החתונה. תיאום ציפיות היום חוסך פיצוצים מחר.',
    },
    {
    ...
    },
    {
      ...
      a: 'לא צריך לפנות לזה סופ"ש. פשוט שולפים קלף ברבע שעה לפני השינה במקום לגלול באינסטגרם. זה פסק-זמן זמין שסוגר פינה של זמן איכות, בלי לצאת מהבית.',
    },
    {
      q: 'זה לא כבד או רציני מדי?',
      a: 'אפס קלישאות. זה לא טיפול זוגי, אלא שאלות קלילות בגובה העיניים שיעשו לכם סדר, יצחיקו אתכם, ויזכירו לכם למה בכלל נכנסתם לכל הטירוף הזה.',
    },
    {
      q: 'מתי הכי כדאי לשחק?',
