...
module.exports = {
  ...
  faq: [
    ...
    {
      q: 'רגע, מי אתם בכלל?',
      a: 'את חמישים השאלות כתב ברק ליור, מפיק חתונות, אחרי שליווה המון זוגות מהרגע שאמרו כן ועד הרגע שעמדו מתחת לחופה. הוא ראה מקרוב אילו שיחות קורות בזמן ואילו נדחות עד שכבר מאוחר לשנות. בשביל זה הקופסה קיימת — שתתכננו את החתונה שלכם עם יותר כיף, פחות סטרס, ושתגיעו לחופה שפויים.',
    },
    {
      q: 'מתי הכי כדאי לשחק?',
    ...
    {
      q: 'אפשר לשלוח את הקופסה ישירות לזוג?',
      a: 'כן. אומרים לנו בהודעה שזו מתנה ונותנים את הכתובת שלהם, והקופסה יוצאת אליהם. החשבונית נשלחת למייל שלכם ולא נכנסת לחבילה, כך שהמחיר לא מגיע יחד עם המתנה.',
    },
    ...
    {
      q: 'אפשר לקבל חשבונית?',
      a: 'כן. החשבונית נשלחת למייל שתשאירו לנו בהזמנה.',
    },
    {
