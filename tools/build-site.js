...
const FAQ = [
  ["כמה זמן זה לוקח?", "כשעה, אבל אתם קובעים את הקצב. אפשר לפנות ערב שלם, לשלוף קלף ברבע שעה לפני השינה או לעצור ולהמשיך בערב אחר. הקלפים לא בורחים."],
  ["מתי הכי כדאי לשחק?", "בחודש הראשון אחרי האירוסין, כשההתרגשות בשיאה ועוד לא סגרתם כלום. זה גם השלב שבו התשובות משפיעות הכי הרבה. אבל גם רגע לפני החופה, זה פסק הזמן הכי שפוי שתיקחו לעצמכם מהבלאגן."],
  ["חברים התארסו, זה מתאים כמתנה?", "ברור. הקופסה מגיעה ארוזה ומוכנה למסירה. עם כל הכבוד לעוד סט מצעים, זו המתנה היחידה שהם אשכרה צריכים עכשיו בשביל זמן איכות בתוך הטירוף."],
  ["איך מקבלים את הקופסה (ואפשר לבטל)?", `משלוח עד הבית כלול במבצע ההשקה (ההזמנות המוקדמות יוצאות ב-${OFFER.shipDate}), או איסוף עצמי ללא עלות בהוד השרון או בגבעת שמואל, בתיאום טלפוני. התחרטתם? אפשר לבטל תוך 14 יום ולהחזיר, כל עוד המוצר באריזה המקורית.`],
  ["אנחנו במילא מדברים כל היום על החתונה, למה צריך קלפים?", "כי אתם מדברים על הפקה: חוזים, מקדמות ואקסלים. הקלפים שמים את הצ'קליסט בצד ונותנים לכם לדבר נטו עליכם, בלי לשכוח את הזוגיות בתוך הארגונים."],
...
const BARAK_SECTION = `<section id="bid-barak" dir="rtl" aria-labelledby="bid-barak-h">
  <div class="bid-b-grid">
    ...
    <div class="bid-b-text">
      ...
      <p>‏'Before I Do' נולד כדי שלא תיזרקו למים העמוקים לגמרי לבד. הבאתי לתוך הקופסה הזו את הידע מעשרות חתונות וזוגות יחד עם כלים מה-NLP, נטו<br>כדי לתת לכם תמיכה מרחוק.</p>
      <p>הרעיון פשוט: אתם מנהלים את התכנון בעצמכם, אבל יש לכם עוגן.<br>משהו ששומר עליכם מפוקסים ודואג שתתקשרו נכון גם כשנהיה לחוץ.</p>
      <p>ואל תדאגו, אם חששתם שזה עוד משחק זוגיות קיטשי ודביק. זה הכי לא.<br>דרך לתאם ציפיות, לשחרר עומס ולהפוך את <em>הדרך לחופה לחוויה שאשכרה נהנים ממנה</em>.</p>
...
<a class="bid-f-ig" href="https://www.instagram.com/beforeido_wedding" target="_blank" rel="noopener" aria-label="Before I Do באינסטגרם">
...
const FOOTER_CSS = `<style>
  ...
  .bid-f-ig:active { transform: translateY(0); }
  @media (max-width: 760px) {
